...
event3= Event.create(name:"On Camera Interview", date:"2020-11-20", artist: squeeze)
event4= Event.create(name:"Studio Session", date:"2021-1-20", artist: iniko)
event5= Event.create(name:" Podcast", date:"2020-12-10", artist: iniko)
event6= Event.create(name:"Video Shoot", date:"2020-11-15", artist: squeeze)
event7= Event.create(name:"Photoshoot", date:"2020-11-23", artist: lisalopes)
...
event12= Event.create(name:"Studio Session", date:"2020-11-16", artist: john)
event13= Event.create(name:"Photoshoot", date:"2020-11-11", artist: iniko)
event14= Event.create(name:"Studio Session", date:"2020-11-23", artist: iniko)
event15= Event.create(name:"Photoshoot", date:"2020-11-06", artist: kaydilluh)
event17= Event.create(name:"On Camera Interview", date:"2020-11-20", artist: guyclaude)
